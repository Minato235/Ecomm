...
// console.log(parentContainer,cart_items)
parentContainer.addEventListener('click', (e) => {

    if (e.target.className == 'shop-item-button') {
        const id = e.target.parentNode.parentNode.id
        const name = document.querySelector(`#${id} span`).innerText;
        const img_src = document.querySelector(`#${id} img`).src;
        let total_cart_price = document.querySelector("#zero").innerText;
        ...
        document.querySelector('#zero').innerText = `${total_cart_price}`;
        cart_item.innerHTML = `
